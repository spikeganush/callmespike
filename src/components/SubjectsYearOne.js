...
function SubjectsYearOne() {
  return (
    <>
      <div className="explanation" id="third_step">
        <p>
          I will show you the different projects I have done during this
          bachelor's. I'm not interested in or good at design (as you will see).
          The focus will be done on the coding subjects.
        </p>

        <p>
          I don't have any projects to show for some subjects, so I will explain
          how the semester was working.
        </p>

        <p>
          In every card, you will have a title, the kind of project, the final
          marks, and the percentage of my code in each language.
        </p>
      </div>
      <div className="year_one_title" id="fourth_step">
        <h1>Year One</h1>
      </div>
        ...
        <div className="card__area">
          <div className="year_wrapper">
            <div className="subject_wrapper">
              <div className="introduction_web_title">
                <h1>Introduction to web:</h1>
              </div>
              <div className="subjects_area">
                <div className="card__class">
                  <h2 className="card__title">Dead Cells</h2>
                  <h2 className="card__team">Solo project</h2>
                  <div className="note">
                    <sup>20</sup>
                    &frasl;
                    <sub>20</sub>
                  </div>
                  <svg viewBox="0 0 128 128" className="language1">
                    <path
                      fill="#E44D26"
                  ...
                  <svg viewBox="0 0 128 128" className="language2">
                    <path
                      fill="#131313"
                  ...
                  <div className="description">
                    First website made with AIT, simple HTML and CSS. The
                    subject was the game Dead Cells.
                  </div>
                  <a
                ...
                <div className="card__class">
                  <h2 className="card__title">Kaltik</h2>
                  <h2 className="card__team">Solo project</h2>
                  <div className="note">
                    <sup>50</sup>
                    &frasl;
                  ...
                  <svg viewBox="0 0 128 128" className="language3">
                    <path
                      fill="#F0DB4F"
                  ...
                  <div className="description">
                    Second website made with AIT, fully responsive with HTML,CSS
                    and JavaScript (to open the menu in mobile browsers, and the
                    modal for the photos). I've rethinked the website Kaltik
                    (frame rollerblading brand).
                  </div>
                  <a
            ...
            <div className="subject_wrapper">
              ...
              <div className="subjects_area">
                <div className="card__class">
                  ...
                  <h2 className="card__team">Semester</h2>
                  <div className="note">
                    <sup>92</sup>
                    &frasl;
                    <sub>100</sub>
                  </div>
                  <svg className="language1" viewBox="0 0 306 344.35">
                    <path
                      fill="#00599C"
                  ...
                  <div className="description">
                    Sadly I don't have any project to show about this subject. I
                    had a weekly tutorial to do, two assignements and a final
                    exam.
                  </div>
                </div>
              </div>
...
export default SubjectsYearOne
