              ...
              <div className="subjects_area">
                <div className="card__class">
                  ...
                  <div className="description">
                    ...
                    you need to wait a bit for the website to load (10 seconds).
                  </div>
                  <a
            ...
            <div className="subject_wrapper">
              ...
              <div className="subjects_area">
                <div className="card__class">
                  ...
                  <div className="description">
                    TrickyDex is an Android App developed in Java. The concept
                    is similar to the PokeDex in Pokemon. It's here to help the
                    beginner in Rollerbading follow his progression in learning
                    new tricks. When you master a trick, you can add it to your
                    TrickyDex. The user has to login to have access to his
                    progression. If the user has the admin credentials, he can
                    add new tricks in the DataBase.
                  </div>
                  <a
                    href="https://github.com/spikeganush/ait-course-review2"
                    target="_blank"
