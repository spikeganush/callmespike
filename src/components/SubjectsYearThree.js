...
function SubjectsYearThree() {
  return (
    <>
      <div className="year_three_title">
        <h1>Year Three</h1>
      </div>
      <div className="year_three">
        <div className="card__area">
          <div className="year_wrapper">
              ...
              <div className="subjects_area">
                <div className="card__class">
                  ...
                  <div className="description">
                    This project was a group project. We had the idea to create
                    a website to give the possibilities to the students to leave
                    a review on the subjects in AIT. I decided to code the
                    website as a MERN (MongoDB, Express, React, Node) project.
                    ...
                    (Tiger). The website is hosted on an Heroku free account, so
                    you need to wait a bit for the website to load (~10
                    seconds).
                  </div>
                  <a
            ...
            <div className="subject_wrapper">
              <div className="introduction_web_title">
                <h1>Mobile Apps Android:</h1>
              </div>
              <div className="subjects_area">
                <div className="card__class">
                  <h2 className="card__title">TrickyDex</h2>
                  ...
                  <div className="description">
                    TrickyDex is an Android App developed in Java and Firebase
                    for the DB. The concept is similar to the PokeDex in
                    Pokemon. It's here to help the beginner in Rollerbading
                    follow his progression in learning new tricks. When you
                    master a trick, you can add it to your TrickyDex. The user
                    has to login to have access to his progression. If the user
                    has the admin credentials, he can add new tricks in the
                    DataBase.
                  </div>
                  <a
            ...
            <div className="subject_wrapper">
              ...
              <div className="subjects_area">
                <div className="card__class">
                  ...
                  <div className="description">
                    I could recode my previous App, TrickyDex, in React-native
                    for this subject. The concept and design are the same. But,
                    to code this App in RN was so much easier than Java.
                    <br /> <br />
                    The App hasn't been published yet, but I'm working on it.
                  </div>
                  <a
...
export default SubjectsYearThree
